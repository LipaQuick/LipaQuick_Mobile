...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const HomePageCropper(title: 'Image Cropper Demo'),
    );
  }
}

class HomePageCropper extends StatefulWidget {
  final String title;

  const HomePageCropper({
    Key? key,
    required this.title,
  }) : super(key: key);

  @override
  _HomePageCropperState createState() => _HomePageCropperState();
}

class _HomePageCropperState extends State<HomePageCropper> {
  XFile? _pickedFile;
