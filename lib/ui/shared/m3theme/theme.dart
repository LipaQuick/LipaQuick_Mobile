...
class MaterialTheme {
  ...
  static MaterialScheme lightScheme() {
    return const MaterialScheme(
      ...
      inversePrimary: Color(0xffa0d49a),
      primaryFixed: Color(0xffbbf0b5),
      onPrimaryFixed: Color(0xff002204),
      primaryFixedDim: Color(0xffa0d49a),
      ...
      tertiaryFixedDim: Color(0xffa1ced4),
  ...
  static MaterialScheme lightHighContrastScheme() {
    return const MaterialScheme(
      ...
      surfaceTint: Color(0xff3b693a),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xff1e4c21),
      onPrimaryContainer: Color(0xffffffff),
  ...
  static MaterialScheme darkScheme() {
    return const MaterialScheme(
      ...
      primary: Color(0xffa0d49a),
      surfaceTint: Color(0xffa0d49a),
  ...
  static MaterialScheme darkHighContrastScheme() {
    return const MaterialScheme(
      ...
      secondaryContainer: Color(0xffbed0b8),
      onSecondaryContainer: Color(0xff000000),
      ...
      secondaryFixedDim: Color(0xffbed0b8),
